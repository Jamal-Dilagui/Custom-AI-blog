...
import { ArrowLeft, Clock, Eye, Heart, Share2, MessageCircle, Twitter, Facebook, Link2, ChevronRight, ShoppingBag } from 'lucide-react'
    ...
    <div className="animate-fade-up">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 pt-8 md:pt-12 grid gap-8 lg:gap-10 lg:grid-cols-12">
        ...
        <article className="lg:col-span-8 min-w-0">
          ...
          {/* Affiliate disclosure (product cards are now inline in the content) */}
          {post.affiliateLinks && post.affiliateLinks.length > 0 && (
            <p className="mt-8 text-xs text-muted-foreground italic border-t border-border/40 pt-4">
              <ShoppingBag className="inline h-3 w-3 mr-1" />
              Affiliate disclosure: Some product links in this article are affiliate links. If you buy something through them, we may earn a small commission at no extra cost to you. We only recommend products we genuinely use and love.
            </p>
          )}
